    ...
    <>
      <section className="relative w-full h-screen overflow-hidden flex flex-col items-center justify-center bg-black text-white">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          {/* Hands placeholders - assuming grayscale cutouts are placed in public folder */}
          {/* The mix-blend-multiply or luminosity will tint them red perfectly */}
          <div className="absolute inset-0 pointer-events-none z-0">
            <img src="/hand-left.png" alt="" className="absolute top-0 left-[-10%] w-[55%] md:w-[45%] object-contain mix-blend-luminosity opacity-40 blur-[1px]" onError={(e) => e.currentTarget.style.display = 'none'} />
            <img src="/hand-right.png" alt="" className="absolute bottom-[-10%] right-[-5%] w-[45%] md:w-[35%] object-contain mix-blend-luminosity opacity-40 blur-[1px]" onError={(e) => e.currentTarget.style.display = 'none'} />
          </div>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 w-full mt-4 max-w-5xl mx-auto">
          ...
          <p className="text-base md:text-[17px] text-white/90 font-inter-tight tracking-wide mt-2">
            Branding • Digital • Architecture • Interiors • Visualization
          </p>
        </div>

        {/* Bottom Elements */}
        <div className="absolute bottom-8 left-0 right-0 px-8 md:px-12 flex justify-between items-end z-10 text-[11px] md:text-xs text-white/60 font-inter-tight tracking-[0.05em] uppercase">
          <div>11:10 PM</div>
